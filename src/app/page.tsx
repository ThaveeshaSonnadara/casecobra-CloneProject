        ...
        >
          <div className="col-span-2 px:6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center flex flex-col items-center lg:text-left lg:items-start">
              ...
              <p
                className="mt-8 text-lg max-w-prose text-center 
              text-balance md:text-wrap lg:text-left lg:pr-10"
              >
          ...
          <div
            className="col-span-full w-full h-fit flex justify-center 
          px-8 mt-32 sm:px-16 md:px-0 lg:col-span-1 lg:mx-0 lg:mt-20"
          >
          ...
          >
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="flex gap-4 mt-2">
                <img
                  src="/users/thaveesha.jpg"
                  className="rounded-full h-12 w-12 object-cover"
                  alt="user one"
                />
              </div>
              <div className="flex flex-col">
                <p className="font-semibold">Thaveesha</p>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  of my previous phone cases. This one, besides a barely
